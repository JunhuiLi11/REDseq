...
<<>>=
	...
	myMapList = buildREmap( REpatternFilePath, BSgenomeName=Celegans, outfile="example.REmap", chr='all')
@
\end{scriptsize}
...
\centering
<<fig1,fig=TRUE>>=
plotCutDistribution(example.assignedREDseq,example.map.list, chr="2",
